...
function $a04ee251ffcc2690$var$ActionGroup(props, ref) {
    props = $8i8bG$useProviderProps(props);
    props = $8i8bG$useSlotProps(props, 'actionGroup');
    ...
    let domRef = $8i8bG$useDOMRef(ref);
    let wrapperRef = $8i8bG$useRef(null);
    let state = $8i8bG$useListState({
        ...props,
        suppressTextValueWarning: true
    });
    let { actionGroupProps: actionGroupProps  } = $8i8bG$useActionGroup(props, state, domRef);
    ...
    let [{ visibleItems: visibleItems1 , hideButtonText: hideButtonText1 , isMeasuring: isMeasuring1  }, setVisibleItems] = $8i8bG$useValueEffect({
        visibleItems: state.collection.size,
        hideButtonText: buttonLabelBehavior === 'hide' && isIconCollapsible,
        isMeasuring: false
    });
    let selectionMode = state.selectionManager.selectionMode;
    let updateOverflow = $8i8bG$useCallback(()=>{
        ...
        let computeVisibleItems = (visibleItems)=>{
            ...
            if (isShowingMenu) calculatedSize += orientation === 'horizontal' ? $a04ee251ffcc2690$var$outerWidth(listItems.pop(), false, true) : $a04ee251ffcc2690$var$outerHeight(listItems.pop(), false, true);
    ...
    $8i8bG$useResizeObserver({
        ref: overflowMode !== 'wrap' ? parentRef : null,
        onResize: updateOverflow
    });
    $8i8bG$useLayoutEffect(updateOverflow, [
        updateOverflow,
        state.collection
    ]);
    let children = [
    ...
    if (overflowMode === 'collapse' && visibleItems1 === 0) {
        menuProps = $8i8bG$filterDOMProps(props, {
            labelable: true
        });
        actionGroupProps = {
        };
    ...
    if (overflowMode === 'collapse' && visibleItems1 < state.collection.size) {
        ...
        menuItem = /*#__PURE__*/ $8i8bG$react.createElement($a04ee251ffcc2690$var$ActionGroupMenu, {
            ...menuProps,
            items: menuChildren,
            onAction: onAction,
            isDisabled: isDisabled,
    ...
    return(/*#__PURE__*/ $8i8bG$react.createElement("div", {
        ...styleProps,
        style: style,
        className: $8i8bG$classNames((/*@__PURE__*/$parcel$interopDefault($331477f4233fd1ae$exports)), 'flex-container', styleProps.className),
        ref: wrapperRef
    }, /*#__PURE__*/ $8i8bG$react.createElement("div", {
        ...actionGroupProps,
        ref: domRef,
        className: $8i8bG$classNames((/*@__PURE__*/$parcel$interopDefault($331477f4233fd1ae$exports)), 'flex-gap', 'spectrum-ActionGroup', {
    ...
    }, /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$Provider, providerProps, children.map((item)=>/*#__PURE__*/ $8i8bG$react.createElement($a04ee251ffcc2690$var$ActionGroupItem, {
            key: item.key,
            onAction: onAction,
            isDisabled: isDisabled,
            isEmphasized: isEmphasized,
 ...
 */ const $a04ee251ffcc2690$export$c21a5597f732a168 = /*#__PURE__*/ $8i8bG$forwardRef($a04ee251ffcc2690$var$ActionGroup);
function $a04ee251ffcc2690$var$ActionGroupItem({ item: item , state: state , isDisabled: isDisabled , isEmphasized: isEmphasized , staticColor: staticColor , onAction: onAction , hideButtonText: hideButtonText , orientation: orientation  }) {
    let ref1 = $8i8bG$useRef();
    let { buttonProps: buttonProps  } = $8i8bG$useActionGroupItem({
        key: item.key
    }, state);
    isDisabled = isDisabled || state.disabledKeys.has(item.key);
    let isSelected = state.selectionManager.isSelected(item.key);
    let { hoverProps: hoverProps , isHovered: isHovered  } = $8i8bG$useHover({
        isDisabled: isDisabled
    });
    let domProps = $8i8bG$filterDOMProps(item.props);
    if (onAction && !isDisabled) buttonProps = $8i8bG$mergeProps(buttonProps, {
    ...
    let textId = $8i8bG$useId();
    let [textContent, setTextContent] = $8i8bG$useState('');
    $8i8bG$useLayoutEffect(()=>{
        var ref;
    ...
    /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$PressResponder, $8i8bG$mergeProps(buttonProps, hoverProps, domProps), /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$ClearSlots, null, /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$SlotProvider, {
        slots: {
            text: {
    ...
    }, /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$ActionButton, {
        ref: ref1,
        UNSAFE_className: $8i8bG$classNames((/*@__PURE__*/$parcel$interopDefault($331477f4233fd1ae$exports)), 'spectrum-ActionGroup-item', {
            'is-selected': isSelected,
            'is-hovered': isHovered,
            'spectrum-ActionGroup-item--iconOnly': hideButtonText,
            'spectrum-ActionGroup-item--isDisabled': isDisabled
        }, $8i8bG$classNames((/*@__PURE__*/$parcel$interopDefault($086e93d2352a4536$exports)), {
    ...
    if (hideButtonText && textContent) button = /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$TooltipTrigger, {
        placement: orientation === 'vertical' ? 'end' : 'top'
    }, button, /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$Tooltip, null, textContent));
...
function $a04ee251ffcc2690$var$ActionGroupMenu({ state: state , isDisabled: isDisabled , isEmphasized: isEmphasized , staticColor: staticColor , items: items , onAction: onAction , summaryIcon: summaryIcon , hideButtonText: hideButtonText , isOnlyItem: isOnlyItem , orientation: orientation , ...otherProps }) {
    ...
    if (!summaryIcon && state.selectionManager.selectionMode === 'single' && state.selectionManager.disallowEmptySelection) {
        ...
        if (selectedItem) {
            ...
            if (typeof summaryIcon === 'string') summaryIcon = /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$Text, null, summaryIcon);
    ...
    summaryIcon = /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$react.Fragment, null, /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$spectrumiconsuiChevronDownMedium, {
        UNSAFE_className: $8i8bG$classNames((/*@__PURE__*/$parcel$interopDefault($331477f4233fd1ae$exports)), 'spectrum-ActionGroup-menu-chevron')
    }), /*#__PURE__*/ $8i8bG$react.createElement("span", {
        className: $8i8bG$classNames((/*@__PURE__*/$parcel$interopDefault($331477f4233fd1ae$exports)), 'spectrum-ActionGroup-menu-contents', {
            'spectrum-ActionGroup-item--iconOnly': iconOnly
        })
    }, summaryIcon));
    return(// Use a PressResponder to send DOM props through.
    /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$MenuTrigger, {
        align: isOnlyItem ? 'start' : 'end',
        direction: orientation === 'vertical' ? 'end' : 'bottom'
    }, /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$SlotProvider, {
        slots: {
            text: {
                id: hideButtonText ? textId : null,
                isHidden: hideButtonText,
                UNSAFE_className: $8i8bG$classNames((/*@__PURE__*/$parcel$interopDefault($331477f4233fd1ae$exports)), 'spectrum-ActionGroup-menu-text')
            }
        }
    }, /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$PressResponder, $8i8bG$mergeProps(buttonProps, hoverProps), /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$ActionButton, {
        ...otherProps,
        id: id,
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledby,
        UNSAFE_className: $8i8bG$classNames((/*@__PURE__*/$parcel$interopDefault($331477f4233fd1ae$exports)), 'spectrum-ActionGroup-item', 'spectrum-ActionGroup-menu', {
            'is-hovered': isHovered,
            'is-selected': isSelected
        }, $8i8bG$classNames((/*@__PURE__*/$parcel$interopDefault($086e93d2352a4536$exports)), {
            'is-selected': isSelected,
        ...
        isDisabled: isDisabled,
        staticColor: staticColor
    }, summaryIcon || /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$spectrumiconsworkflowMore, null)))), /*#__PURE__*/ $8i8bG$react.createElement($8i8bG$Menu, {
        items: items,
        ...
        ,
        onAction: onAction
    }, (node)=>/*#__PURE__*/ $8i8bG$react.createElement($8i8bG$Item, {
