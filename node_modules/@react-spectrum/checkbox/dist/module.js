...
import {Label as $gpy1V$Label} from "@react-spectrum/label";
...
const $8c8ab388b155237e$export$baf37c4be89255b8 = $gpy1V$react.createContext(null);
...
function $25b6292d81af2844$var$Checkbox(props, ref) {
    ...
    let markIcon = isIndeterminate ? /*#__PURE__*/ $gpy1V$react.createElement($gpy1V$spectrumiconsuiDashSmall, {
        UNSAFE_className: $gpy1V$classNames((/*@__PURE__*/$parcel$interopDefault($fe1a56c62936037c$exports)), 'spectrum-Checkbox-partialCheckmark')
    }) : /*#__PURE__*/ $gpy1V$react.createElement($gpy1V$spectrumiconsuiCheckmarkSmall, {
        UNSAFE_className: $gpy1V$classNames((/*@__PURE__*/$parcel$interopDefault($fe1a56c62936037c$exports)), 'spectrum-Checkbox-checkmark')
    });
    if (groupState) {
        for (let key of [
            'isSelected',
    ...
    return(/*#__PURE__*/ $gpy1V$react.createElement("label", {
        ...styleProps,
        ...hoverProps,
        ref: domRef,
        className: $gpy1V$classNames((/*@__PURE__*/$parcel$interopDefault($fe1a56c62936037c$exports)), 'spectrum-Checkbox', {
        ...
        focusRingClass: $gpy1V$classNames((/*@__PURE__*/$parcel$interopDefault($fe1a56c62936037c$exports)), 'focus-ring'),
        autoFocus: autoFocus
    }, /*#__PURE__*/ $gpy1V$react.createElement("input", {
        ...inputProps,
        ref: inputRef,
        className: $gpy1V$classNames((/*@__PURE__*/$parcel$interopDefault($fe1a56c62936037c$exports)), 'spectrum-Checkbox-input')
    })), /*#__PURE__*/ $gpy1V$react.createElement("span", {
        className: $gpy1V$classNames((/*@__PURE__*/$parcel$interopDefault($fe1a56c62936037c$exports)), 'spectrum-Checkbox-box')
    }, markIcon), children && /*#__PURE__*/ $gpy1V$react.createElement("span", {
        className: $gpy1V$classNames((/*@__PURE__*/$parcel$interopDefault($fe1a56c62936037c$exports)), 'spectrum-Checkbox-label')
    }, children)));
}
/**
...
function $73f43ce9d441cc69$var$CheckboxGroup(props, ref) {
    ...
    return(/*#__PURE__*/ $gpy1V$react.createElement("div", {
        ...styleProps,
        ...groupProps,
        className: $gpy1V$classNames((/*@__PURE__*/$parcel$interopDefault($4cb2b26710154c56$exports)), 'spectrum-FieldGroup', {
            'spectrum-FieldGroup--positionSide': labelPosition === 'side'
        }, // This is so checkbox group works inside a <Form>
        $gpy1V$classNames((/*@__PURE__*/$parcel$interopDefault($cd231e464c886c86$exports)), 'spectrum-Field'), styleProps.className),
        ref: domRef
    ...
    }, label), /*#__PURE__*/ $gpy1V$react.createElement("div", {
        role: "presentation",
