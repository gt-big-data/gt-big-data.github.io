...
export function A4uFolderAddTo({scale = 'M', color = 'LIGHT', ...props}) {
  return (
    <svg viewBox={viewBoxes[scale]} {...props}>
      <path d="M12.064 27.418l8.356-9.076a3.086 3.086 0 0 1 2.213-.961 3.044 3.044 0 0 1 3.041 3.037v.943A13.842 13.842 0 0 1 34 25.605V11a1 1 0 0 0-1-1H2v21a1 1 0 0 0 1 1h13.285z" />
