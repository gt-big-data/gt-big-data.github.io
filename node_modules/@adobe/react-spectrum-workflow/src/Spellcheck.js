...
export function A4uSpellcheck({scale = 'M', color = 'LIGHT', ...props}) {
  return (
    <svg viewBox={viewBoxes[scale]} {...props}>
      <path d="M33.614 11.344l-1.455-1.133a1 1 0 0 0-1.4.175L17.124 27.9l-6.647-6.61a1 1 0 0 0-1.414 0l-1.325 1.325a1 1 0 0 0 0 1.414l8.926 8.9a1 1 0 0 0 1.5-.093l15.629-20.09a1 1 0 0 0-.179-1.402z" />
