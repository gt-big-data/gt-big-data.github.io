...
export function A4uEmailExcludeOutline({
  scale = 'M',
  color = 'LIGHT',
  ...props
}) {
  return (
    <svg viewBox={viewBoxes[scale]} {...props}>
      ...
      <path d="M27 18.1a8.9 8.9 0 1 0 8.9 8.9 8.9 8.9 0 0 0-8.9-8.9zM27 34a6.966 6.966 0 0 1-5.525-11.252l9.777 9.777A6.935 6.935 0 0 1 27 34zm5.525-2.748l-9.777-9.777a6.966 6.966 0 0 1 9.777 9.777z" />
    </svg>
  );
}
