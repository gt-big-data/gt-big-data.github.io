...
export function A4uGearsEdit({scale = 'M', color = 'LIGHT', ...props}) {
  return (
    <svg viewBox={viewBoxes[scale]} {...props}>
      ...
      <path d="M35.738 21.764l-3.506-3.506a.739.739 0 0 0-.527-.215h-.023a.834.834 0 0 0-.564.247L20.3 29.113a.611.611 0 0 0-.153.256l-2.027 6c-.069.229.279.517.477.517a.284.284 0 0 0 .037 0c.168-.039 5.123-1.764 6-2.028a.591.591 0 0 0 .252-.152l10.82-10.828a.834.834 0 0 0 .246-.537.742.742 0 0 0-.214-.577zM19.7 34.3l1.56-4.431 2.871 2.863c-1.309.391-3.29 1.225-4.431 1.568z" />
    </svg>
  );
}
