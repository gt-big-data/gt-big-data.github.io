...
export function A4uTextTracking({scale = 'M', color = 'LIGHT', ...props}) {
  return (
    <svg viewBox={viewBoxes[scale]} {...props}>
      ...
      <path d="M32.834 30.128l-4-4A.49.49 0 0 0 28.5 26a.5.5 0 0 0-.5.5V29H8v-2.5a.5.5 0 0 0-.5-.5.49.49 0 0 0-.331.129l-4 4a.5.5 0 0 0 0 .744l4 4A.49.49 0 0 0 7.5 35a.5.5 0 0 0 .5-.5V32h20v2.5a.5.5 0 0 0 .5.5.49.49 0 0 0 .331-.129l4-4a.5.5 0 0 0 0-.744z" />
    </svg>
  );
}
