...
export function A4uBack30Seconds({scale = 'M', color = 'LIGHT', ...props}) {
  return (
    <svg viewBox={viewBoxes[scale]} {...props}>
      <path d="M24.031 2.675L25.853.854A.49.49 0 0 0 26 .5a.5.5 0 0 0-.5-.5h-5.053A.5.5 0 0 0 20 .447V5.5a.5.5 0 0 0 .5.5.494.494 0 0 0 .35-.147l1.58-1.58a14.44 14.44 0 0 1-1.93 27.994.6.6 0 0 0-.5.585V33.9a.408.408 0 0 0 .463.4 16.471 16.471 0 0 0 3.568-31.625z" />
