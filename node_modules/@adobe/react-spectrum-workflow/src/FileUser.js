...
export function A4uFileUser({scale = 'M', color = 'LIGHT', ...props}) {
  return (
    <svg viewBox={viewBoxes[scale]} {...props}>
      ...
      <path d="M16 2L6 12h10zm13 0H18v11a1 1 0 0 1-1 1H6v19a1 1 0 0 0 1 1h6.139a8.711 8.711 0 0 1 6.551-7.041 10.262 10.262 0 0 1-1.41-5.031c0-4.959 3.16-8.424 7.686-8.424A7.55 7.55 0 0 1 30 14.625V3a1 1 0 0 0-1-1z" />
    </svg>
  );
}
