...
export function A4uRadialGradient({scale = 'M', color = 'LIGHT', ...props}) {
  return (
    <svg viewBox={viewBoxes[scale]} {...props}>
      ...
      <path d="M14.1 32h7.8A14.551 14.551 0 0 0 32 21.9v-7.8A14.551 14.551 0 0 0 21.9 4h-7.8A14.551 14.551 0 0 0 4 14.1v7.8A14.551 14.551 0 0 0 14.1 32zM18 5.273A12.727 12.727 0 1 1 5.273 18 12.727 12.727 0 0 1 18 5.273z" />
