...
export function A4uSelectGear({scale = 'M', color = 'LIGHT', ...props}) {
  return (
    <svg viewBox={viewBoxes[scale]} {...props}>
      ...
      <path d="M18.55 18.1L8.5 8.086A.285.285 0 0 0 8.294 8 .292.292 0 0 0 8 8.292v19.139a.292.292 0 0 0 .294.293.285.285 0 0 0 .2-.086l4.37-5.657h2.939A12.318 12.318 0 0 1 18.55 18.1z" />
    </svg>
  );
}
