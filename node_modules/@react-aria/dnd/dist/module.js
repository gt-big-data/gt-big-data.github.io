...
import {getInteractionModality as $fP8tg$getInteractionModality, useInteractionModality as $fP8tg$useInteractionModality, setInteractionModality as $fP8tg$setInteractionModality, useFocus as $fP8tg$useFocus} from "@react-aria/interactions";
...
class $67560de7c78cb232$var$DragSession {
    setup() {
        ...
        $fP8tg$announce(this.stringFormatter.format($67560de7c78cb232$var$MESSAGES[$7252cd45fc48c07c$export$1fb2158d224b542c()]));
    }
    teardown() {
    ...
    setCurrentDropTarget(dropTarget, item) {
        ...
        if (item !== this.currentDropItem) {
            ...
            if (!this.initialFocused) {
                $fP8tg$announce(item === null || item === void 0 ? void 0 : item.element.getAttribute('aria-label'), 'polite');
    ...
    cancel() {
        ...
        $fP8tg$announce(this.stringFormatter.format('dropCanceled'));
    }
    drop(item1) {
        if (!this.currentDropTarget) {
            this.cancel();
        ...
        this.end();
        $fP8tg$announce(this.stringFormatter.format('dropComplete'));
    }
    activate() {
...
function $8253ed7ece74b463$export$7941f8aafa4b6021(options) {
    let stringFormatter = $fP8tg$useLocalizedStringFormatter((/*@__PURE__*/$parcel$interopDefault($c530af5bd0e7e6c6$exports)));
    ...
    let descriptionProps = $fP8tg$useDescription(stringFormatter.format(!isDragging ? $8253ed7ece74b463$var$MESSAGES[modality].start : $8253ed7ece74b463$var$MESSAGES[modality].end));
    return {
        dragProps: {
            draggable: 'true',
...
function $224594fe3e57ff1e$export$62447ad3d2ec7da6() {
    ...
    let descriptionProps = $fP8tg$useDescription(dragSession ? stringFormatter.format($224594fe3e57ff1e$var$MESSAGES[modality]) : '');
    return {
        dropProps: {
            ...descriptionProps,
